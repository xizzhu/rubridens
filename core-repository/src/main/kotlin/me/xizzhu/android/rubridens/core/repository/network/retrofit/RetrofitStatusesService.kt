...
internal class RetrofitStatusesService : StatusesService {
    override suspend fun fetch(userOAuthToken: String?, statusId: EntityKey): Status {
        ...
        return request<MastodonStatusesService, MastodonStatus>(statusId.instanceUrl) {
 ...
 */
internal interface MastodonStatusesService {
